"""
Génère automatiquement un server.py complet avec tous les handlers Outlook (85+).

Ce script crée un fichier server.py production-ready avec:
- Tous les tools Outlook (85+)
- Tous les handlers mappés
- Lifecycle complet
...
# Liste complète des méthodes Outlook avec leurs paramètres
OUTLOOK_METHODS = {
    # Mail Operations (12)
    "send_email": {
...
print(f"Total méthodes Outlook configurées : {len(OUTLOOK_METHODS)}")

#  Sauvegarder la configuration
config_file = Path(__file__).parent / "outlook_methods_config.json"
with open(config_file, "w", encoding="utf-8") as f:
    json.dump(OUTLOOK_METHODS, f, indent=2, ensure_ascii=False)

print(f"✅ Configuration sauvegardée dans {config_file}")
print("\nMaintenance note: Utilisez ce fichier pour générer server.py automatiquement")
print("avec tous les handlers Outlook configurés correctement.")
