...
WORD_TOOLS_CONFIG = {
    ...
    "add_table_row": {"required": ["table_index"], "optional": [], "desc": "Add row to table."},
    "add_table_column": {
    ...
    "delete_table_column": {
        "required": ["table_index", "col_index"],
        "optional": [],
    ...
    "resize_image": {
        "required": ["image_index", "width", "height"],
        "optional": [],
        "desc": "Resize image.",
    },
    "position_image": {
        "required": ["image_index"],
        "optional": ["wrap_format"],
    ...
    "insert_page_break": {"required": [], "optional": [], "desc": "Insert page break."},
    ...
    "configure_section": {
        ...
        "optional": ["orientation", "page_width", "page_height"],
        "desc": "Configure section properties.",
    },
    "enable_track_changes": {"required": [], "optional": [], "desc": "Enable track changes."},
    "disable_track_changes": {"required": [], "optional": [], "desc": "Disable track changes."},
    "add_comment": {
        "required": ["text"],
        "optional": ["range_start", "range_end"],
        "desc": "Add comment to document.",
    },
    "accept_all_revisions": {"required": [], "optional": [], "desc": "Accept all revisions."},
    "reject_all_revisions": {"required": [], "optional": [], "desc": "Reject all revisions."},
    "get_document_properties": {"required": [], "optional": [], "desc": "Get document properties."},
    "set_document_properties": {
        "required": [],
        "optional": ["author", "title", "subject", "keywords"],
        "desc": "Set document properties.",
    },
    "get_document_statistics": {"required": [], "optional": [], "desc": "Get document statistics."},
    ...
    "configure_print_settings": {
        "required": [],
        "optional": ["copies", "page_range", "collate"],
        "desc": "Configure print settings.",
    },
    "print_preview": {"required": [], "optional": [], "desc": "Show print preview."},
    "protect_document": {
        "required": ["protection_type"],
        "optional": ["password"],
        "desc": "Protect document.",
    },
    "set_password": {"required": ["password"], "optional": [], "desc": "Set document password."},
    "unprotect_document": {
        "required": [],
        "optional": ["password"],
    ...
    "create_index": {"required": [], "optional": [], "desc": "Create index."},
    "manage_bibliography": {
        "required": [],
        "optional": ["source_file"],
        "desc": "Manage bibliography.",
    },
    "insert_field": {"required": ["field_type"], "optional": ["text"], "desc": "Insert field."},
    "compare_documents": {
        "required": ["original_path", "revised_path"],
        "optional": [],
        "desc": "Compare two documents.",
    },
    "insert_smartart": {"required": [], "optional": ["layout"], "desc": "Insert SmartArt."},
    "convert_format": {
        "required": ["output_path", "file_format"],
        "optional": [],
        "desc": "Convert document format.",
    },
    "modify_style": {"required": ["style_name"], "optional": [], "desc": "Modify existing style."},
    "insert_hyperlink": {
        "required": ["text", "url"],
        "optional": ["range_start", "range_end"],
...
EXCEL_TOOLS_CONFIG = {
    "create_workbook": {"required": [], "optional": [], "desc": "Create a new workbook."},
    "open_workbook": {
        "required": ["file_path"],
        "optional": [],
    ...
    "add_worksheet": {"required": [], "optional": ["name"], "desc": "Add a new worksheet."},
    "delete_worksheet": {"required": ["sheet_name"], "optional": [], "desc": "Delete a worksheet."},
    "rename_worksheet": {
    ...
    "move_worksheet": {
        "required": ["sheet_name", "position"],
        "optional": [],
        "desc": "Move a worksheet to a different position.",
    },
    "hide_worksheet": {"required": ["sheet_name"], "optional": [], "desc": "Hide a worksheet."},
    "show_worksheet": {
        "required": ["sheet_name"],
        "optional": [],
    ...
    "write_range": {
        "required": ["sheet_name", "range_addr", "values"],
        "optional": [],
    ...
    "read_range": {
        "required": ["sheet_name", "range_addr"],
        "optional": [],
        "desc": "Read values from a range.",
    },
    "copy_paste_cells": {
        "required": ["sheet_name", "source_range", "dest_range"],
        "optional": [],
    ...
    "find_and_replace": {
        "required": ["sheet_name", "find_text", "replace_text"],
        "optional": [],
    ...
    "use_function": {
        "required": ["sheet_name", "cell", "function_name", "range_addr"],
        "optional": [],
        "desc": "Use common function (SUM, AVERAGE, IF, etc.).",
    },
    "use_vlookup": {
        "required": ["sheet_name", "cell", "lookup_value", "table_array", "col_index"],
    ...
    "use_array_formula": {
        "required": ["sheet_name", "range_addr", "formula"],
        "optional": [],
        "desc": "Apply array formula.",
    },
    "set_number_format": {
        "required": ["sheet_name", "range_addr", "format_code"],
        "optional": [],
        "desc": "Set number format.",
    },
    "set_cell_color": {
        "required": ["sheet_name", "range_addr", "r", "g", "b"],
        "optional": [],
    ...
    "set_column_width": {
        "required": ["sheet_name", "column", "width"],
        "optional": [],
        "desc": "Set column width.",
    },
    "set_row_height": {
        "required": ["sheet_name", "row", "height"],
        "optional": [],
        "desc": "Set row height.",
    },
    "conditional_formatting": {
        "required": ["sheet_name", "range_addr", "condition_type"],
        "optional": [],
    ...
    "add_total_row": {
        "required": ["sheet_name", "table_name"],
        "optional": [],
        "desc": "Add total row to table.",
    },
    "apply_table_style": {
        "required": ["sheet_name", "table_name", "style_name"],
        "optional": [],
        "desc": "Apply style to table.",
    },
    "filter_table": {
        "required": ["sheet_name", "table_name", "column", "criteria"],
        "optional": [],
        "desc": "Filter table.",
    },
    "sort_table": {
        "required": ["sheet_name", "table_name", "column"],
        "optional": ["ascending"],
        "desc": "Sort table.",
    },
    "insert_image": {
        "required": ["sheet_name", "image_path", "cell"],
        "optional": ["width", "height"],
        "desc": "Insert image in worksheet.",
    },
    "resize_image": {
        "required": ["sheet_name", "image_index", "width", "height"],
        "optional": [],
        "desc": "Resize image.",
    },
    "position_image": {
        "required": ["sheet_name", "image_index", "left", "top"],
        "optional": [],
        "desc": "Position image.",
    },
    "anchor_image_to_cell": {
        "required": ["sheet_name", "image_index", "cell"],
        "optional": [],
        "desc": "Anchor image to cell.",
    },
    "insert_logo_watermark": {
        "required": ["sheet_name", "image_path"],
        "optional": [],
        "desc": "Insert logo/watermark.",
    },
    "create_chart": {
        "required": ["sheet_name", "chart_type", "source_range"],
        "optional": ["chart_title"],
        "desc": "Create chart.",
    },
    "modify_chart_data": {
        "required": ["sheet_name", "chart_index", "new_range"],
        "optional": [],
        "desc": "Modify chart data source.",
    },
    "customize_chart_title": {
        "required": ["sheet_name", "chart_index", "title"],
        "optional": [],
        "desc": "Customize chart title.",
    },
    "customize_chart_legend": {
        "required": ["sheet_name", "chart_index"],
        "optional": ["position"],
    ...
    "change_chart_colors": {
        "required": ["sheet_name", "chart_index", "color_scheme"],
        "optional": [],
    ...
    "create_pivot_table": {
        "required": ["source_sheet", "source_range", "dest_sheet", "dest_cell", "table_name"],
        "optional": [],
        "desc": "Create pivot table.",
    },
    "set_pivot_fields": {
        "required": ["sheet_name", "pivot_table_name"],
        "optional": ["row_fields", "column_fields", "value_fields"],
        "desc": "Set pivot table fields.",
    },
    "apply_pivot_filter": {
        "required": ["sheet_name", "pivot_table_name", "field", "values"],
        "optional": [],
        "desc": "Apply filter to pivot table.",
    },
    "change_pivot_calculation": {
        "required": ["sheet_name", "pivot_table_name", "field", "function"],
        "optional": [],
    ...
    "create_advanced_filter": {
        "required": ["sheet_name", "data_range", "criteria_range"],
        "optional": [],
    ...
    "create_named_range": {
        "required": ["name", "sheet_name", "range_addr"],
        "optional": [],
        "desc": "Create named range.",
    },
    "use_named_range_in_formula": {
        "required": ["sheet_name", "cell", "range_name"],
        "optional": ["function"],
        "desc": "Use named range in formula.",
    },
    "delete_named_range": {"required": ["name"], "optional": [], "desc": "Delete named range."},
    ...
    "set_validation_rules": {
        "required": ["sheet_name", "range_addr", "validation_type", "formula1"],
        "optional": ["formula2"],
    ...
    "configure_print_settings": {
        "required": ["sheet_name"],
        "optional": ["orientation", "paper_size"],
        "desc": "Configure print settings.",
    },
    "set_print_area": {
        "required": ["sheet_name", "range_addr"],
    ...
    "print_preview": {"required": ["sheet_name"], "optional": [], "desc": "Show print preview."},
    "group_rows_columns": {
        "required": ["sheet_name", "range_addr"],
        "optional": ["is_rows"],
        "desc": "Group rows or columns.",
    },
    "freeze_panes": {"required": ["sheet_name", "cell"], "optional": [], "desc": "Freeze panes."},
    "split_window": {
        "required": ["sheet_name"],
        "optional": ["horizontal_split", "vertical_split"],
        "desc": "Split window.",
    },
    "create_sparklines": {
        "required": ["sheet_name", "data_range", "location_range"],
        "optional": ["sparkline_type"],
        "desc": "Create sparklines.",
    },
    "scenario_analysis": {
        "required": ["sheet_name", "scenario_name", "changing_cells", "values"],
        "optional": [],
        "desc": "Create scenario for analysis.",
    },
    "goal_seek": {
        "required": ["sheet_name", "set_cell", "to_value", "by_changing_cell"],
        "optional": [],
        "desc": "Perform goal seek.",
    },
    "use_solver": {"required": ["sheet_name"], "optional": [], "desc": "Use Solver add-in."},
    "consolidate_data": {
        "required": ["dest_sheet", "dest_range", "source_ranges"],
        "optional": ["function"],
        "desc": "Consolidate data from multiple ranges.",
    },
    "create_subtotals": {
        "required": ["sheet_name", "range_addr", "group_by"],
        "optional": ["function"],
        "desc": "Create automatic subtotals.",
    },
    "import_csv": {
        "required": ["sheet_name", "csv_path"],
        "optional": ["dest_cell"],
        "desc": "Import CSV data.",
    },
    "insert_hyperlink": {
        "required": ["sheet_name", "cell", "url"],
        "optional": ["display_text"],
        "desc": "Insert hyperlink.",
    },
    "insert_comment": {
        "required": ["sheet_name", "cell", "comment_text"],
        "optional": [],
        "desc": "Insert comment/note.",
    },
    "use_3d_reference": {
        "required": ["dest_sheet", "dest_cell", "first_sheet", "last_sheet", "cell_ref"],
        "optional": ["function"],
        "desc": "Use 3D reference across sheets.",
    },
    "export_to_json": {
        "required": ["sheet_name", "range_addr", "output_path"],
        "optional": [],
...
POWERPOINT_TOOLS_CONFIG = {
    "create_presentation": {"required": [], "optional": [], "desc": "Create a new presentation."},
    "open_presentation": {
        "required": ["file_path"],
        "optional": [],
    ...
    "add_slide": {"required": [], "optional": ["layout"], "desc": "Add a new slide."},
    "delete_slide": {"required": ["slide_index"], "optional": [], "desc": "Delete a slide."},
    "duplicate_slide": {"required": ["slide_index"], "optional": [], "desc": "Duplicate a slide."},
    "move_slide": {
        "required": ["slide_index", "new_position"],
        "optional": [],
    ...
    "modify_body_text": {
        "required": ["slide_index", "body_text"],
        "optional": [],
        "desc": "Modify slide body text.",
    },
    "add_bullets": {
        "required": ["slide_index", "bullet_points"],
        "optional": [],
    ...
    "format_text": {
        ...
        "optional": ["font_name", "font_size", "bold", "italic", "color_rgb"],
    ...
    "resize_image": {
        "required": ["slide_index", "shape_index", "width", "height"],
        "optional": [],
        "desc": "Resize image.",
    },
    "reposition_image": {
        "required": ["slide_index", "shape_index", "left", "top"],
        "optional": [],
        "desc": "Reposition image.",
    },
    "insert_video": {
        "required": ["slide_index", "video_path", "left", "top", "width", "height"],
        "optional": [],
        "desc": "Insert video on slide.",
    },
    "insert_audio": {
        "required": ["slide_index", "audio_path", "left", "top"],
        "optional": [],
    ...
    "modify_fill_color": {
        "required": ["slide_index", "shape_index", "r", "g", "b"],
        "optional": [],
        "desc": "Modify shape fill color.",
    },
    "modify_outline": {
        "required": ["slide_index", "shape_index"],
        "optional": ["color_rgb", "weight"],
        "desc": "Modify shape outline.",
    },
    "group_shapes": {
        "required": ["slide_index", "shape_indices"],
        "optional": [],
        "desc": "Group multiple shapes.",
    },
    "ungroup_shapes": {
        "required": ["slide_index", "group_index"],
        "optional": [],
        "desc": "Ungroup shapes.",
    },
    "insert_table": {
    ...
    "merge_table_cells": {
        "required": ["slide_index", "table_index", "start_row", "start_col", "end_row", "end_col"],
        "optional": [],
        "desc": "Merge table cells.",
    },
    "split_table_cell": {
        "required": ["slide_index", "table_index", "row", "col", "num_rows", "num_cols"],
        "optional": [],
        "desc": "Split table cell.",
    },
    "apply_table_style": {
        "required": ["slide_index", "table_index", "style_id"],
        "optional": [],
        "desc": "Apply style to table.",
    },
    "format_table_borders": {
        "required": ["slide_index", "table_index", "color_rgb", "weight"],
        "optional": [],
        "desc": "Format table borders.",
    },
    "insert_chart": {
        "required": ["slide_index", "chart_type", "left", "top", "width", "height"],
        "optional": [],
        "desc": "Insert chart on slide.",
    },
    "link_excel_chart": {
        "required": ["slide_index", "excel_path", "left", "top", "width", "height"],
        "optional": [],
        "desc": "Insert chart linked to Excel.",
    },
    "modify_chart_data": {
        "required": ["slide_index", "chart_index", "data"],
        "optional": [],
        "desc": "Modify chart data.",
    },
    "customize_chart_style": {
        "required": ["slide_index", "chart_index", "style_id"],
        "optional": [],
        "desc": "Customize chart style.",
    },
    "add_entrance_animation": {
        "required": ["slide_index", "shape_index", "effect_type"],
        "optional": [],
    ...
    "set_animation_order": {
        "required": ["slide_index", "animation_index", "new_order"],
        "optional": [],
        "desc": "Set animation order.",
    },
    "configure_animation_timing": {
        "required": ["slide_index", "animation_index"],
        "optional": ["duration", "delay"],
        "desc": "Configure animation timing.",
    },
    "apply_transition": {
        "required": ["slide_index", "transition_type"],
        "optional": [],
        "desc": "Apply transition to slide.",
    },
    "set_transition_duration": {
        "required": ["slide_index", "duration"],
        "optional": [],
    ...
    "add_speaker_notes": {
        "required": ["slide_index", "notes_text"],
        "optional": [],
    ...
    "add_comment": {
        "required": ["slide_index", "text", "left", "top"],
        "optional": ["author"],
        "desc": "Add comment to slide.",
    },
    "start_presenter_mode": {"required": [], "optional": [], "desc": "Start presenter mode."},
    "set_slide_timing": {
        "required": ["slide_index", "advance_time"],
        "optional": [],
    ...
    "insert_smartart": {
        "required": ["slide_index", "layout", "left", "top", "width", "height"],
        "optional": [],
        "desc": "Insert SmartArt.",
    },
    "insert_ole_object": {
        "required": ["slide_index", "file_path", "left", "top", "width", "height"],
        "optional": [],
        "desc": "Insert OLE object (Excel, equations, etc.).",
    },
    "create_section_zoom": {
        "required": ["slide_index", "section_name", "left", "top"],
        "optional": [],
        "desc": "Create section zoom.",
    },
    "insert_hyperlink": {
        "required": ["slide_index", "shape_index", "url"],
        "optional": ["target_slide"],
        "desc": "Insert hyperlink to shape.",
    },
    "add_action_trigger": {
        "required": ["slide_index", "shape_index", "action_type"],
        "optional": [],
    ...
    "add_captions": {
        "required": ["slide_index", "caption_text"],
        "optional": [],
...
OUTLOOK_TOOLS_CONFIG = {
    ...
    "delete_email": {"required": ["email_entry_id"], "optional": [], "desc": "Supprime un email"},
    ...
    "create_new_message": {"required": [], "optional": [], "desc": "Crée un nouveau brouillon"},
    "create_folder": {
        "required": ["folder_name"],
        "optional": ["parent_folder"],
        "desc": "Crée un dossier",
    },
    "delete_folder": {"required": ["folder_path"], "optional": [], "desc": "Supprime un dossier"},
    "rename_folder": {
    ...
    "get_calendar_count": {"required": [], "optional": [], "desc": "Compte les rendez-vous"},
    "export_to_pdf": {
        "required": ["output_path"],
        "optional": [],
    ...
    "search_contact": {"required": ["search_term"], "optional": [], "desc": "Recherche un contact"},
    "list_all_contacts": {"required": [], "optional": [], "desc": "Liste tous les contacts"},
    ...
    "import_contacts": {"required": ["file_path"], "optional": [], "desc": "Importe des contacts"},
    "create_task": {
        "required": ["subject"],
    ...
    "delete_task": {"required": ["task_entry_id"], "optional": [], "desc": "Supprime une tâche"},
    "mark_task_complete": {
        "required": ["task_entry_id"],
        "optional": [],
    ...
    "list_tasks": {"required": [], "optional": ["completed"], "desc": "Liste les tâches"},
    "list_accounts": {"required": [], "optional": [], "desc": "Liste les comptes"},
    "get_default_account": {"required": [], "optional": [], "desc": "Obtient le compte par défaut"},
    "get_inbox_count": {"required": [], "optional": [], "desc": "Compte les messages inbox"},
    "create_category": {"required": ["name"], "optional": ["color"], "desc": "Crée une catégorie"},
    "list_categories": {"required": [], "optional": [], "desc": "Liste les catégories"},
    "apply_category": {
